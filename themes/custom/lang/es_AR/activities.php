...
return [
    ...
    // Books
    'book_create'                 => 'manual creado',
    'book_create_notification'    => 'Manual creado correctamente',
    'book_create_from_chapter'              => 'capítulo convertido en manual',
    'book_create_from_chapter_notification' => 'Capítulo convertido en manual con éxito',
    'book_update'                 => 'manual actualizado',
    'book_update_notification'    => 'Manual actualizado correctamente',
    'book_delete'                 => 'manual borrado',
    'book_delete_notification'    => 'Manual eliminado correctamente',
    'book_sort'                   => 'manual ordenado',
    'book_sort_notification'      => 'Manual reordenado correctamente',

    // Bookshelves
    'bookshelf_create'            => 'sistema creado',
    'bookshelf_create_notification'    => 'Sistema creado correctamente',
    'bookshelf_create_from_book'    => 'manual convertido en sistema',
    'bookshelf_create_from_book_notification'    => 'Manual convertido en sistema con éxito',
