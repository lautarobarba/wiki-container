...
return [
    ...
    // Sorting Settings
    'sorting' => 'Ordenando',
    'sorting_book_default' => 'Orden predeterminado del manual',
    'sorting_book_default_desc' => 'Seleccione la regla de ordenación predeterminada para aplicar a nuevos manuales. Esto no afectará a los manuales existentes, y puede ser anulado por manual.',
    ...
    'sort_rule_assigned_to_x_books' => 'Asignado a :count manual | Asignado a :count manuales',
    ...
    'sort_rule_delete_desc' => 'Eliminar esta regla de ordenación del sistema. Los Manuales que utilicen este tipo se revertirán a la ordenación manual.',
    'sort_rule_delete_warn_books' => 'Esta regla de ordenación se utiliza actualmente en :count manual(es). ¿Está seguro que desea eliminarla?',
    'sort_rule_delete_warn_default' => 'Esta regla de ordenación se utiliza actualmente como predeterminada para los manuales. ¿Está seguro de que desea eliminarla?',
    ...
    'sort_rule_operations_desc' => 'Configure las acciones de ordenación a realizar moviéndolas de la lista de operaciones disponibles. Al usarse, las operaciones se aplicarán en orden, de arriba a abajo. Cualquier cambio realizado aquí se aplicará a todos los manuales asignados al guardar.',
    ...
    'role_manage_entity_permissions' => 'Gestionar todos los permisos de manuales, capítulos y páginas',
    'role_manage_own_entity_permissions' => 'Gestionar permisos en manual
    ...
    'role_asset_desc' => 'Estos permisos controlan el acceso por defecto a los activos del sistema. Permisos definidos en Manuales, Capítulos y Páginas ignorarán estos permisos.',
